...
\noindent\fbox{%
  \parbox{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}{%
    	\textbf{Instrucciones:} La tarea se puede realizar en grupos de 4 con un plazo máximo hasta el x de x; no se aceptarán atrasos. El formato deberá ser entregada en físico (letra legible o \LaTeX{}), además de entrega virtual de los códigos que utilicen.
  }%
}
