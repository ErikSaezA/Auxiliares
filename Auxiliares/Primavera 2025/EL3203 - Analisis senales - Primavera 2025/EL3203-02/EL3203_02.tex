...
\begin{parts}
  ...
  \part Bajo el setting del punto (c), verifique que la relación $\big(x(n)\big)_{n\ge 0} \mapsto \big(y_{SO}(n)\big)_{n\ge 0}$ determina un sistema LTI.
  \part Bajo el setting del punto (c), verifique que la relación $(y_1,\ldots,y_N) \mapsto \big(y_{IO}(n)\big)_{n\ge 0}$ es lineal.
\end{parts}
