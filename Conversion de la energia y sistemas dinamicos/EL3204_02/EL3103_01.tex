...
\begin{questions}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.4\textwidth]{Auxiliar_2_1}
    ...
    \begin{solution}
        ...
        %AGREGAR IMAGEN DE CIRCUITO MAGNETICO
        ...
        %AGREGAR CIRCUITO CON UNA FUENTE PRENDIDA
        ...
        %AGREGAR CIRCUITO CON AMBAS FUENTES PRENDIDAS
        ...
        %%% AGREGAR IMAGEN DEL SISTEMA DE REFERENCIA QUE UTILIZO
...
\subsection*{Resolucion 2.1}
   ...
   %%AGREGAR IMAGEN DE COMO SE COMPORTA EL SISTEMA
   ...
   Notamos que la corriente dependera del tiempo. Tenemos por tanto que la reluctancia vendra dada por:
    ...
    %%%% AGREGAR FOTO DEL SISTEMA ELECTRICO
...
\begin{solution}
    ...
    %%AGREGAR LA IMAGEN DE LAS POLARIDADES
...
\end{align}
%%AGREGAR IMAGEN DE REFERENCIA DE Z2
